...
from .adapter import FoundryDevOpsAgentAdapter


def main() -> None:
    """CLI entrypoint for the Foundry DevOps Status Agent solution."""
    try:
        ...
        if len(sys.argv) > 1:
            ...
            print(
                "Enter your prompt (e.g., 'What is the status of my build?'): ",
                end="",
                flush=True,
            )
