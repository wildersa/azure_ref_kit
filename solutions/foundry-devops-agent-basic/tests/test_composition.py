...
@patch("src.adapter.get_build_status_safe")
def test_adapter_chat_response_with_tool_call(
    ...
    2. Adapter routes to get_build_status_safe.
...
def test_adapter_handles_tool_failure_sanitized(
    ...
    mock_call.type = "function_call"
    mock_call.name = "get_build_status"
    mock_call.arguments = json.dumps({"build_id": 1})
    ...
    # second_call_input is a list of ResponseInputParam which are dicts
